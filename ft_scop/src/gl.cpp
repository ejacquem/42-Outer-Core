...
#include "../external/stb_image.h" //load texture
#include "../external/glad/include/glad/glad.h" //load opengl function
#include "../external/glfw-3.4/include/GLFW/glfw3.h" //window handling
